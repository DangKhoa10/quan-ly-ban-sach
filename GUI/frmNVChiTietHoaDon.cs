...
{
    public partial class frmNVChiTietHoaDon : Form
    {
        public frmNVChiTietHoaDon()
        {
            InitializeComponent();
        }
        public frmNVChiTietHoaDon(string maHoaDon, string ngayLapHD)
        {
            InitializeComponent();
        ...
        private void frmNVChiTietHoaDon_Load(object sender, EventArgs e)
        {
        ...
        private void frmNVChiTietHoaDon_FormClosing(object sender, FormClosingEventArgs e)
        {
            DialogResult r;
